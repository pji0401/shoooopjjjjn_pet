...
class _MissionWriteScreenState extends State<MissionWriteScreen> {
  ...
  // 이미지 갤러리 섹션을 별도의 메소드로 분리
  Widget _buildImageGallerySection(double imageHeight, double imageWidth) {
    return SizedBox(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: Colors.white.withOpacity(
                                  0.6), // withValues 대신 withOpacity 사용
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildImageGallerySection(imageHeight, imageWidth),
