...
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CupertinoApp(
      ...
      home: const RootView(title: 'Flutter Layout Demo'),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      child: SafeArea(
        ...
        bottom: false, // Disable the bottom padding
        child: Column(
          children: [
            Expanded(
              child: _widgetOptions[_selectedIndex],
            ),
            // CupertinoTabBar should be positioned at the bottom but not affected by SafeArea
            CupertinoTabBar(
